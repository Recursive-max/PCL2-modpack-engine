...
<!--  ⛏ 关于 · HeroInfoCard v2  -->
<!-- ================================ -->
<!-- 配置：主标题/副标题/按钮文字 改下方对应 Text 属性即可 -->
     ...
     <Border Background="#E8F5F5F7" CornerRadius="10" Padding="0,0,0,0"
          ...
          <StackPanel>
               ...
               <Grid Margin="24,16,16,16">
                    ...
                    <!-- === 左侧：图标 + 主标题 + 副标题 === -->
                    <!-- @config: 改下方 TextBlock Text 即可修改标题和副标题 -->
                    <StackPanel Grid.Column="0" VerticalAlignment="Center">
                         <StackPanel Orientation="Horizontal">
                              <TextBlock Text="⚒" FontSize="16" 
                                   Foreground="#9B59B6" VerticalAlignment="Center" Margin="0,0,10,0" />
                              <TextBlock x:Name="MainTitle" Text="PCL2 整合包推荐引擎" 
                                   FontSize="20" FontWeight="Bold"
                                   Foreground="#9B59B6" VerticalAlignment="Center" />
                         </StackPanel>
                         <TextBlock x:Name="SubTitle" Text="By GDSGDHG" FontSize="11"
                              Foreground="#B07CC6" Margin="26,3,0,0" />
                    </StackPanel>

                    <!-- === 右侧：竖排快捷入口 === -->
                    <!-- @config: 改下方 TextBlock Text 修改按钮文字 -->
               ...
               <!-- 底部紫色强调渐变条（紫色→透明渐变效果） -->
               <Border Height="3" CornerRadius="0,0,10,10">
                    <Border.Background>
                         <LinearGradientBrush StartPoint="0,0" EndPoint="1,0">
                              <GradientStop Color="#9B59B6" Offset="0.0" />
                              <GradientStop Color="#B07CC6" Offset="0.5" />
                              <GradientStop Color="#309B59B6" Offset="1.0" />
                         </LinearGradientBrush>
                    </Border.Background>
               </Border>
          </StackPanel>
